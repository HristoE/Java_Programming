...
public static final String programmingLanguage;
    ...
    public CydeoDevStudent(String name, char gender, LocalDate dateOfBirth, String id, String batchName, int batchNumber) {
        ...
        if ( getAge()<18){ // constructor always need to be in first step, condition can be after constructor is executed
            System.err.println( "Cydeo developer student needs to be 18 years old " );
            System.exit(1);
    ...
    public void setBatchName(String batchName) {
        if ( batchName.equalsIgnoreCase("zero to heero ")|| batchName.equalsIgnoreCase("alumni dev")){
            batchName = batchName;
    ...
    @Override
    public void drink() {
        System.out.println( getBatchName() + " is drinking "+ programmingLanguage) ;
