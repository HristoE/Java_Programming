...
public class PolymorphismIntro {
    ...
    public static void main(String[] args) {
        ...
        //Eagle eagle;
       // eagle = new Eagle("Orel"," American",'F',3,"Large", "Black");
        ...
        Animal[] animals = {dog, cat, tiger, lion, dolphin, shark, duck};
        ...
        Honda honda = new Honda("Accord",1998,20222,"Silver");

        Audi audi = new Audi("Q6",2020, 36000, "Silver");
